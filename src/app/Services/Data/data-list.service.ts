...
export class DataListService {
  private list: GameItem[] = [
    ...
    { id: 5, name: 'Monopoli', description: "Monopoli lorem ipsum", category: 4, rating: 6, price: 49.99, year: 1980 },
    ...
    { id: 18, name: 'Coloretto', description: "Coloretto lorem ipsum", category: 6, rating: 7, price: 34.99, year: 2018 },
  ];
